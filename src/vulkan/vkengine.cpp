...
VkEngine::VkEngine(int width, int height)
    : width_(width)
    , height_(height) {
    initWindow();
    initVulkan();
...
void VkEngine::createInstance() {
    ...
    if (enableValidationLayers) {
        ...
        defaultDebugMessengerCreateInfo(debugCreateInfo);
...
void VkEngine::setupDebugMessenger() {
    ...
    defaultDebugMessengerCreateInfo(createInfo);
...
void VkEngine::pickPhysicalDevice() {
    ...
    Info("%u devices found.", deviceCount);
...
void VkEngine::createSwapChain() {
    ...
    VkExtent2D extent = updateSwapExtent(swapChainSupport.capabilities, width_, height_);
